...
### 5. Source map resolution reads arbitrary files without permission check when --permission is enabled

- **Severity:** medium
- **Status:** active
- **Location:** lib/internal/source_map/source_map_cache.js
- **Commit:** 58cd0b8df278d1932dac036e3ea93c16d1a7aaa6
- **Detected (PST):** 2026-06-23T02:59:51+00:00
...
### 6. Source map resolution reads arbitrary files without permission checks
